...
const HUB_GRADIENTS: Record<string, { gradient: string; text: string; bg: string; labelEn: string; labelNl: string }> = {'disney-and-fairy-tales': { gradient:'linear-gradient(135deg, #FF6B8B 0%, #FFD166 100%)', text:'#E11D48', bg:'rgba(255, 107, 139, 0.12)', labelEn:'Disney & Fairytales', labelNl:'Disney & Sprookjes'},'tv-series-and-movies': { gradient:'linear-gradient(135deg, #6366F1 0%, #A855F7 100%)', text:'#4F46E5', bg:'rgba(99, 102, 241, 0.12)', labelEn:'TV & Movies', labelNl:'TV & Films'},'games-and-pop-culture': { gradient:'linear-gradient(135deg, #00D2D3 0%, #54A0FF 100%)', text:'#0284C7', bg:'rgba(0, 210, 211, 0.12)', labelEn:'Games & Pop Culture', labelNl:'Games & Popcultuur'},'animals-and-nature': { gradient:'linear-gradient(135deg, #10B981 0%, #059669 100%)', text:'#059669', bg:'rgba(16, 185, 129, 0.12)', labelEn:'Animals & Nature', labelNl:'Dieren & Natuur'},'girls-themes': { gradient:'linear-gradient(135deg, #EC4899 0%, #F472B6 100%)', text:'#DB2777', bg:'rgba(236, 72, 153, 0.12)', labelEn:'Magic & Fairies', labelNl:'Magie & Sprookjes'},'toddler-specific': { gradient:'linear-gradient(135deg, #F97316 0%, #FBBF24 100%)', text:'#D97706', bg:'rgba(249, 115, 22, 0.12)', labelEn:'Preschool & Toddlers', labelNl:'Peuters & Kleuters'},'adults': { gradient:'linear-gradient(135deg, #8B5CF6 0%, #EC4899 100%)', text:'#7C3AED', bg:'rgba(139, 92, 246, 0.12)', labelEn:'Mindfulness & Adults', labelNl:'Mindfulness & Volwassenen'},'mandalas': { gradient:'linear-gradient(135deg, #7C3AED 0%, #C084FC 100%)', text:'#6D28D9', bg:'rgba(124, 58, 237, 0.12)', labelEn:'Intricate Mandalas', labelNl:'Ingewikkelde Mandala\'s'},'school-education-templates': { gradient:'linear-gradient(135deg, #84CC16 0%, #10B981 100%)', text:'#65A30D', bg:'rgba(132, 204, 22, 0.12)', labelEn:'School & Education', labelNl:'School & Educatie'},
};
