    ...
    <footer className={styles.footer}>
      <div className={styles.footerContainer}>
        <div className={styles.footerTop}>
          ...
          <div className={styles.links}>
            ...
            <div className={styles.linkColumn}>
              ...
              <CookieSettingsButton isEn={isEn} />
            </div>
          </div>
        </div>
        ...
        <div style={{
          ...
          {isEn
            ? 'All coloring pages on ColorVaults are created using digital illustration tools, calibrated for clear high-contrast outlines, and provided 100% free for personal, home, and educational use.'
            : 'Alle kleurplaten op ColorVaults zijn ontworpen met digitale illustratietools, geoptimaliseerd voor duidelijke lijnen en 100% gratis beschikbaar voor persoonlijk en educatief gebruik.'}
        </div>
