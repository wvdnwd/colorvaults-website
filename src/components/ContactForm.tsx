...
export default function ContactForm({ lang, isEn }: { lang: string; isEn: boolean }) {
 ...
 {isEn 
 ?'Your message has been sent successfully. We will get back to you within 2 business days.':'Je bericht is succesvol verzonden. We nemen binnen 2 werkdagen contact met je op.'}
 </p>
 <button 
 onClick={() => {
 ...
 >
 {status ==='submitting'? (isEn ?'Sending...':'Verzenden...') 
