    ...
    <div className={styles.splashContainer} aria-hidden="true">
      ...
      >
        ...
        <g filter="url(#watercolorBlur)">
          <path
            d="M420,130 C520,110 610,160 640,240 C670,320 620,410 540,460 C460,510 330,520 250,470 C170,420 140,320 170,230 C200,140 320,150 420,130 Z"
            fill="url(#splashCore)"
            opacity="0.95"
          />
          <path
            d="M360,90 C460,70 560,110 590,180 C620,250 560,300 480,280 C400,260 300,290 240,240 C180,190 260,110 360,90 Z"
            fill="url(#splashGrad1)"
            opacity="0.9"
          />
          <path
            d="M470,220 C570,200 660,260 680,340 C700,420 640,490 560,490 C480,490 430,420 380,380 C330,340 370,240 470,220 Z"
            fill="url(#splashGrad2)"
            opacity="0.9"
          />
          <path
            d="M280,300 C370,290 440,350 470,420 C500,490 440,540 360,550 C280,560 210,510 180,440 C150,370 190,310 280,300 Z"
            fill="url(#splashGrad3)"
            opacity="0.9"
          />
        </g>
