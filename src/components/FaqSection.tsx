      ...
      <div className="container">
        <div className={styles.faqHeader}>
          ...
          <p style={{ color: 'var(--gray-600)', maxWidth: '640px', margin: '0.6rem auto 0', lineHeight: 1.6 }}>
            {isEn
              ? 'Find answers to common questions about paper sizes, printer settings, educational use, and adult mindfulness coloring.'
              : 'Vind antwoorden op vragen over printerinstellingen, A4-formaat, gebruik in de klas en ontspannend kleuren voor volwassenen.'}
          </p>
        </div>
