    ...
    <div>
      ...
      <div className={styles.filterBar}>
        <div className={styles.filterGroup}>
          <input
            type="search"
            placeholder="🔍 Zoek categorie of slug..."
            value={search}
        ...
        <div className={styles.chipGroup} style={{ margin: 0 }}>
          <button
            type="button"
            className={`${styles.chipBtn} ${statusFilter === 'all' ? styles.chipActive : ''}`}
          ...
          <button
            type="button"
            className={`${styles.chipBtn} ${statusFilter === 'empty' ? styles.chipActive : ''}`}
          ...
          <button
            type="button"
            className={`${styles.chipBtn} ${statusFilter === 'low' ? styles.chipActive : ''}`}
          ...
          <button
            type="button"
            className={`${styles.chipBtn} ${statusFilter === 'growing' ? styles.chipActive : ''}`}
          ...
          <button
            type="button"
            className={`${styles.chipBtn} ${statusFilter === 'good' ? styles.chipActive : ''}`}
