    ...
    <section style={{
      ...
      <div style={{ marginBottom: '2rem' }}>
        <span style={{
          ...
          ✂️ {isEn ? 'Crafts & Activities' : 'Knutsel- & Lesideeën'}
        </span>
        <h2 style={{
          fontSize: '1.75rem',
          fontWeight: 800,
        ...
        <p style={{ color: '#64748B', fontSize: '1rem', marginTop: '0.4rem', lineHeight: 1.6 }}>
          {isEn
            ? `Turn your finished ${themeTitle} coloring sheets into wonderful hands-on art projects for home or school!`
            : `Verander je ingekleurde ${themeTitle} kleurplaten in creatieve knutselwerkjes voor thuis of in de klas!`}
        </p>
      </div>
