...
export default function PrintDownloadButtons({
  ...
  const handleDownloadPdf = async (e: React.MouseEvent) => {
    ...
    try {
      ...
      pdf.text(`© ColorVaults.com — ${pageTitle} — Free for personal, home and classroom educational use.`,
        pageWidth / 2,
        pageHeight - 6,
        { align:'center'}
      );
    ...
    <>
      <div style={{ marginTop:'1.5rem', display:'flex', flexDirection:'column', gap:'0.75rem'}}>
        ...
        <button
          ...
          className="download-btn"style={{ width:'100%', justifyContent:'center', cursor:'pointer', fontSize:'1rem', padding:'0.95rem'}}
          type="button">
        ...
        <button
          ...
          className="btn-secondary"style={{ width:'100%', justifyContent:'center', cursor: downloading ?'not-allowed':'pointer', display:'flex', alignItems:'center', gap:'0.5rem'}}
          type="button">
          <svg width="17"height="17"viewBox="0 0 24 24"fill="currentColor"aria-hidden="true">
