    ...
    <section style={{
      ...
      <div style={{ flex: '1 1 340px' }}>
        ...
        <p style={{ color: '#C7D2FE', fontSize: '0.975rem', lineHeight: 1.6, margin: '0 0 1.5rem' }}>
          {isEn
            ? 'Join thousands coloring today’s community spotlight! Complete the digital artwork or print it out to unlock your daily Masterpiece Certificate.'
            : 'Kleur vandaag mee met duizenden anderen! Kleur de plaat digitaal in of print hem uit voor je dagelijkse diploma.'}
        </p>
        ...
        <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
          ...
          >
            🖨️ {isEn ? 'Print Free PDF' : 'Gratis Printen'}
          </Link>
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ aspectRatio: '3/4', position: 'relative', borderRadius: '10px', overflow: 'hidden', background: '#F8FAFC' }}>
          <SafeImage
            src="https://colorvaults.ams3.cdn.digitaloceanspaces.com/banner/hub_fantasy-fairytales.webp"
            alt="Daily Coloring Page"
            width={200}
            height={260}
