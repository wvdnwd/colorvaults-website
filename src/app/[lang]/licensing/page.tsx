...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    ...
    description: lang === 'en'
      ? 'Learn about licensing and commercial use of ColorVaults content.'
      : 'Lees meer over licenties en commercieel gebruik van ColorVaults content.',
  };
}
    ...
    <>
      <div className="page-hero">
        <div className="container">
          ...
          <p style={{ color: 'var(--gray-600)', fontSize: '1.1rem', marginTop: '0.5rem', maxWidth: '600px', lineHeight: 1.7 }}>
            {isEn
              ? 'All ColorVaults pages are free for personal use. For commercial use, please read our licensing terms.'
              : 'Alle ColorVaults kleurplaten zijn gratis voor persoonlijk gebruik. Voor commercieel gebruik, lees onze licentievoorwaarden.'}
          </p>
        </div>
      </div>
      ...
      <div className="container section">
            ...
            >
              ...
              {tier.highlight && (
                <a
                  ...
                  style={{ marginTop: '2rem', display: 'inline-flex', width: '100%', justifyContent: 'center' }}
                >
        ...
        <div className="seo-block">
          ...
          <p>
            {isEn
              ? 'ColorVaults grants you a non-exclusive, royalty-free license to download and use our coloring pages for personal, educational, and non-commercial purposes. You may not redistribute, sell, or use our pages in any commercial product without a commercial license.'
              : 'ColorVaults verleent u een niet-exclusieve, royaltyvrije licentie om onze kleurplaten te downloaden en te gebruiken voor persoonlijke, educatieve en niet-commerciële doeleinden. U mag onze pagina\'s niet herverspreiden, verkopen of gebruiken in commerciële producten zonder een commerciële licentie.'}
          </p>
          <p>
            {isEn
              ? 'For licensing inquiries, please contact us via our contact page. We\'ll get back to you within 2 business days.'
              : 'Voor licentievragen kunt u contact met ons opnemen via onze contactpagina. We reageren binnen 2 werkdagen.'}
          </p>
        </div>
      </div>
    </>
