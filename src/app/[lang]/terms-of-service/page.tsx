...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    ...
    description: lang === 'en'
      ? 'Read the Terms of Service for ColorVaults — including AI content disclosure, licensing, and usage rules.'
      : 'Lees de Algemene Voorwaarden van ColorVaults — inclusief AI content transparantie, licenties en gebruiksregels.',
  };
}
    ...
    <div className="container section">
      <div style={{ maxWidth: '820px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem', color: 'var(--gray-800)', lineHeight: '1.7' }}>
          ...
          <div style={{
            ...
            <p style={{ margin: 0 }}>
              {isEn
                ...
                : 'Alle kleurplaten, afbeeldingen, illustraties en lijntekeningen op ColorVaults.com zijn gemaakt met behulp van Kunstmatige Intelligentie (AI) tools en algoritmen. Door de inhoud van deze website te bekijken, te downloaden of af te drukken, erkent u en gaat u ermee akkoord dat de kunstwerken AI-gegenereerd zijn en onderworpen zijn aan de hierin uiteengezette voorwaarden.'
              }
            </p>
          </div>
          ...
          <p>
            {isEn
              ? 'By using ColorVaults.com ("the Website"), you enter into a binding agreement to comply with these Terms of Service. If you do not agree with any part of these terms, please discontinue use of the Website immediately.'
              : 'Door gebruik te maken van ColorVaults.com ("de Website"), gaat u een bindende overeenkomst aan om te voldoen aan deze Algemene Voorwaarden. Indien u niet akkoord gaat met enig onderdeel van deze voorwaarden, dient u het gebruik van de Website onmiddellijk te staken.'
            }
          </p>
          ...
          <p>
            {isEn
              ? 'ColorVaults grants you a non-exclusive, non-transferable, revocable license to access, download, and print AI-generated coloring pages under the following conditions:'
              : 'ColorVaults verleent u een niet-exclusieve, niet-overdraagbare, herroepbare licentie om AI-gegenereerde kleurplaten te bekijken, te downloaden en af te drukken onder de volgende voorwaarden:'
            }
          </p>
          <ul style={{ paddingLeft: '1.75rem', display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
            <li>
              ...
              {isEn
                ? 'You may print and color our pages at home for your own enjoyment, or with your family and friends.'
                : 'U mag onze pagina\'s thuis afdrukken en inkleuren voor uw eigen plezier, of met uw familie en vrienden.'
              }
            </li>
            <li>
              <strong>{isEn ? 'Educational Use:' : 'Educatief Gebruik:'}</strong>{' '}
              {isEn
                ? 'Teachers, educators, daycare providers, and schools are permitted to print multiple copies for classroom activities.'
                : 'Docenten, opvoeders, kinderopvanglocaties en scholen is het toegestaan om meerdere exemplaren af te drukken voor klasactiviteiten.'
              }
            </li>
            <li>
              <strong>{isEn ? 'Commercial Restrictions:' : 'Commerciële Beperkingen:'}</strong>{' '}
              {isEn
                ? 'You may not sell, redistribute, bundle in physical books, or resell digital files or printed copies of our AI artwork for profit without prior written authorization.'
                : 'Het is niet toegestaan om onze AI-illustraties of digitale bestanden te verkopen, te herdistribueren, op te nemen in fysieke boeken of afgedrukte exemplaren met winstoogmerk te verkopen zonder voorafgaande schriftelijke toestemming.'
              }
            </li>
          </ul>
          ...
          <p>
            {isEn
              ? 'All AI artwork and services provided on ColorVaults are offered on an "AS IS" and "AS AVAILABLE" basis. We make no express or implied warranties regarding completeness, suitability, or error-free rendering.'
              : 'Alle AI-illustraties en diensten op ColorVaults worden aangeboden op een "ZOALS ZE ZIJN" en "ZOALS BESCHIKBAAR" basis. Wij geven geen uitdrukkelijke of stilzwijgende garanties met betrekking tot volledigheid, geschiktheid of foutloze weergave.'
            }
          </p>
          ...
          <p>
            {isEn
              ? 'For questions regarding these Terms or AI Content disclosures, please contact us at:'
              : 'Voor vragen over deze Voorwaarden of AI Content verklaringen kunt u contact met ons opnemen via:'
            }
          </p>
