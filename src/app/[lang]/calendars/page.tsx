...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    title: isEn
      ?'Free Printable 2026 & 2027 Coloring Calendars (12-Month PDF Bundle) | ColorVaults':'Gratis Printbare 2026 & 2027 Kleurkalender (12 Maanden PDF Bundel) | ColorVaults',
    description: isEn
      ?'Download and print our free 12-month printable coloring calendar for 2026 and 2027! Includes cute monthly coloring headers and planning grids for kids, classrooms, and home.':'Download en print onze gratis 12-maanden jaarkalender voor 2026 en 2027! Met vrolijke kleurplaat-koppen en handige maandvakken voor kinderen, scholen en thuis.',
  };
}
