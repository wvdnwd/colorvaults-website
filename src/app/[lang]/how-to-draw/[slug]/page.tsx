...
export async function generateMetadata({
  ...
  return {
    title: isEn
      ?`${lesson.titleEn} (Step-by-Step Drawing Tutorial) | ColorVaults`:`${lesson.titleNl} (Stap voor Stap Tekengids) | ColorVaults`,
      ...
      <div className="container section"style={{ maxWidth:'900px'}}>
        ...
        <div style={{
          ...
          <p style={{ color:'#94A3B8', fontSize:'0.975rem', maxWidth:'540px', margin:'0 auto 1.5rem', lineHeight: 1.6 }}>
            {isEn
              ?'Print this full-page guide with step diagrams and grid paper for students to practice drawing right at their desk!':'Print deze complete gids met stappendiagrammen en ruitjespapier zodat kinderen direct op papier kunnen oefenen!'}
          </p>
          <button
            type="button"className="btn-primary"style={{ fontSize:'1rem', padding:'0.85rem 2rem', cursor:'pointer'}}
          >
            {isEn ?'Print Free Worksheet (PDF)':'Print Oefenblad (PDF)'}
          </button>
        </div>
