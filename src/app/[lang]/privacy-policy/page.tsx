...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return {
    ...
    description: lang === 'en'
      ? 'Read the Privacy Policy for ColorVaults — how we handle cookies, Google AdSense, Analytics, and GDPR data protection.'
      : 'Lees het Privacybeleid van ColorVaults — hoe wij omgaan met cookies, Google AdSense, Analytics en AVG gegevensbescherming.',
  };
}
    ...
    <div className="container section">
      <div style={{ maxWidth: '820px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem', color: 'var(--gray-800)', lineHeight: '1.7' }}>
          ...
          <p>
            {isEn
              ? 'ColorVaults ("we", "us", or "our") operates the website colorvaults.com ("the Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.'
              : 'ColorVaults ("wij", "ons" of "onze") beheert de website colorvaults.com ("de Dienst"). Deze pagina informeert u over ons beleid met betrekking tot het verzamelen, gebruiken en openbaarmaken van persoonsgegevens wanneer u onze Dienst gebruikt en de keuzes die u heeft met betrekking tot die gegevens.'
            }
          </p>
          ...
          <p>
            {isEn
              ? 'ColorVaults is designed to be accessible without requiring any user registration or account creation. We collect minimal personal data under the following circumstances:'
              : 'ColorVaults is ontworpen om toegankelijk te zijn zonder dat gebruikersregistratie of het aanmaken van een account vereist is. Wij verzamelen een minimale hoeveelheid persoonsgegevens in de volgende gevallen:'
            }
          </p>
            ...
            <ul style={{ paddingLeft: '1.25rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '0.9rem' }}>
              <li>
                {isEn
                  ...
                  : 'Leveranciers van derden, waaronder Google, gebruiken cookies om advertenties weer te geven op basis van eerdere bezoeken van een gebruiker aan onze website of andere websites.'
                }
              </li>
              <li>
                {isEn
                  ...
                  : 'Door het gebruik van advertentiecookies kunnen Google en zijn partners advertenties weergeven op basis van het bezoek aan onze sites en/of andere sites op het internet.'
                }
              </li>
              <li>
                {isEn
                  ...
                  : 'Gebruikers kunnen zich afmelden voor gepersonaliseerde advertenties door naar Google Advertentie-instellingen (www.google.com/settings/ads) of www.aboutads.info te gaan.'
                }
              </li>
            </ul>
          </div>
          ...
          <p>
            {isEn
              ? 'We use Google Analytics to analyze website traffic, aggregate user interactions, and improve site performance. Google Analytics uses cookies to collect non-identifiable usage statistics with IP anonymization enabled.'
              : 'Wij gebruiken Google Analytics om het websiteverkeer te analyseren, gebruikersinteracties te aggregeren en de prestaties van de site te verbeteren. Google Analytics gebruikt cookies om niet-identificeerbare gebruiksstatistieken te verzamelen met IP-anonimisering ingeschakeld.'
            }
          </p>
          ...
          <p>
            {isEn
              ? 'If you are a resident of the European Union (EU) or European Economic Area (EEA), you possess statutory data protection rights under the General Data Protection Regulation (GDPR):'
              : 'Indien u woonachtig bent in de Europese Unie (EU) of Europese Economische Ruimte (EER), beschikt u over wettelijke rechten op het gebied van gegevensbescherming onder de Algemene Verordening Gegevensbescherming (AVG):'
            }
          </p>
          ...
          <div style={{ background: 'var(--gray-100)', padding: '1.25rem 1.5rem', borderRadius: 'var(--radius)' }}>
            <strong>Email:</strong> <a href="mailto:privacy@colorvaults.com" style={{ color: 'var(--primary)' }}>privacy@colorvaults.com</a>
          </div>
