...
export async function generateMetadata({ params }: { params: Promise<{ lang: string }> }) {
 ...
 description: lang ==='en'?'Get in touch with the ColorVaults team. We love hearing from our community!':'Neem contact op met het ColorVaults team. We horen graag van onze community!',
 };
}
...
export default async function ContactPage({ params }: { params: Promise<{ lang: string }> }) {
 ...
 {isEn
 ?'Whether you need a specific coloring page, want to report an issue, or have a business inquiry — reach out and we\'ll get back to you within 2 business days.':'Of je nu een specifieke kleurplaat nodig hebt, een probleem wil melden of een zakelijke vraag hebt — neem contact op en we reageren binnen 2 werkdagen.'}
 </p>
 ...
 ✉️ <a href="mailto:colorvault@hotmail.com"style={{ color:'inherit', textDecoration:'underline'}}>colorvault@hotmail.com</a>
 </p>
