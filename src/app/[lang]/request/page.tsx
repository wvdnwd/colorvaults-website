...
export default async function RequestPage({ params }: { params: Promise<{ lang: string }> }) {
 ...
 {isEn
 ?"Can't find the coloring page you're looking for? Let us know and we'll try to add it!":'Kun je de kleurplaat die je zoekt niet vinden? Laat het ons weten en we proberen hem toe te voegen!'}
 </p>
 </div>
 </div>
 ...
 <p>
 {isEn
 ?'We love hearing from our community! If there\'s a character, theme, or style you want to see on ColorVaults, send us a message and we\'ll do our best to create it.':'We horen graag van onze community! Als er een personage, thema of stijl is die je op ColorVaults wilt zien, stuur ons dan een bericht en we doen ons best om het te maken.'}
 </p>
 <p style={{ marginTop:'1rem'}}>
 {isEn
 ?'Popular requests are prioritized and added to our upcoming releases. You\'ll receive credit on the page as the person who requested it!':'Populaire aanvragen krijgen prioriteit en worden toegevoegd aan onze aankomende releases. Je ontvangt een vermelding op de pagina als degene die het heeft aangevraagd!'}
 </p>
 </div>
